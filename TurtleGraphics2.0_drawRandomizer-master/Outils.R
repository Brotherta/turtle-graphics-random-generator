...
{
  ## on définit les couleurs des biomes 
...
OutilsFeuillage<-function(vecteur,taille_monde,taille_vecteur,couleur_biome,biome)
{
  ...
  {
    # On commence par un Oursin de la couleur du biome, puis plus petit un Oursin vert foncé.
...
OutilsBuisson <- function(posX,posY,vecteur,taille_vecteur,biome)
{
  ...
  # Le buisson se compose de la mÃªme maniere que les feuillages des arbres.
